...
def load_dataset_for_streams(identifier, 
    ...
    if identifier == 'BIN:rbf_1':
        ...
        data = pd.read_csv('./datasets_streaming/rbf_1.csv', names=feature_names, index_col=False, delimiter=',', header=0)
    ...
    if identifier == 'BIN:rbf_2':
        ...
        data = pd.read_csv('./datasets_streaming/rbf_2.csv', names=feature_names, index_col=False, delimiter=',', header=0)
    ...
    if identifier == 'BIN:rbf_3':
        ...
        data = pd.read_csv('./datasets_streaming/rbf_3.csv', names=feature_names, index_col=False, delimiter=',', header=0)
    ...
    if identifier == 'BIN:rbf_4':
        ...
        data = pd.read_csv('./datasets_streaming/rbf_4.csv', names=feature_names, index_col=False, delimiter=',', header=0)
    ...
    if identifier == 'BIN:rbf_5':
        ...
        data = pd.read_csv('./datasets_streaming/rbf_5.csv', names=feature_names, index_col=False, delimiter=',', header=0)
